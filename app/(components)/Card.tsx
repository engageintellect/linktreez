  ...
  return (
    <>
      <a
        href={url}
        target="_blank"
        className="my-2 group transition-color duration-300 sm:hover:bg-zinc-900 bg-zinc-800 h-20 w-full sm:w-[66vw] md:w-[50vw] xl:w-[33vw] rounded-lg shadow-lg flex items-center justify-between"
        rel="noreferrer"
      >
